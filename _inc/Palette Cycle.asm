...
PalCycle_EHZ:
	...
	lea	CyclingPal_EHZ_ARZ_Water(pc),a0
...
+	lea	(Normal_palette_line4+$12).w,a1
	move.l	(a0,d0.w),(a1)+
	move.l	4(a0,d0.w),(a1)
	lea	CyclingPal_HPZUnderwater(pc),a0
...
+
	...
	move.w	$18(a0),$58(a1)
	move.w	$1E(a0),$5A(a1)
	lea	CyclingPal_CNZ3(pc),a0
	lea	(a0,d0.w),a0
	move.w	0(a0),$64(a1)
	move.w	6(a0),$66(a1)
	move.w	$C(a0),$68(a1)
	lea	CyclingPal_CNZ4(pc),a0
...
CNZ_SkipToBossPalCycle:
	...
	blo.s	+
	move.w	#0,(PalCycle_Frame2).w
+	lea	CyclingPal_CNZ1_B(pc),a0
	lea	(a0,d0.w),a0
	lea	(Normal_palette).w,a1
	move.w	0(a0),$24(a1)
	move.w	6(a0),$26(a1)
	move.w	$C(a0),$28(a1)
	lea	CyclingPal_CNZ2_B(pc),a0
	move.w	(PalCycle_Frame3).w,d0
	addq.w	#2,(PalCycle_Frame3).w
	cmpi.w	#$14,(PalCycle_Frame3).w
	blo.s	+
...
PalCycle_WFZ:
	...
	bpl.s	+++
	move.w	#1,(PalCycle_Timer).w
	lea	CyclingPal_WFZFire(pc),a0
	tst.b	(WFZ_SCZ_Fire_Toggle).w
	beq.s	+
	move.w	#5,(PalCycle_Timer).w
	lea	CyclingPal_WFZBelt(pc),a0
+	move.w	(PalCycle_Frame).w,d0
...
PalCycle_SuperSonic:
	...
	lea	CyclingPal_SSTransformation(pc),a0
...
+
	...
	move.l	4(a0,d0.w),(a1)
	; underwater palettes
	lea	CyclingPal_CPZUWTransformation(pc),a0
	cmpi.b	#chemical_plant_zone,(Current_Zone).w
	beq.s	+
	cmpi.b	#aquatic_ruin_zone,(Current_Zone).w
	bne.s	.return
	lea	CyclingPal_ARZUWTransformation(pc),a0
