...
.offsets:
	...
	dc.w  $300, $380, $400, $480, $500, $580	; 24
	dc.w  $600, $680, $700, $780, $800, $880	; 30
	dc.w  $600, $680, $700, $780, $800, $880	; 36
	dc.w  $900, $980, $A00, $A80, $B00, $B80	; 42
	dc.w  $900, $980, $A00, $A80, $B00, $B80	; 48
	dc.w  $C00, $C80, $D00, $D80, $E00, $E80	; 54
	dc.w  $C00, $C80, $D00, $D80, $E00, $E80	; 60
	dc.w  $F00, $F80,$1000,$1080,$1100,$1180	; 66
	dc.w  $F00, $F80,$1000,$1080,$1100,$1180	; 72
	dc.w $1200,$1280,$1300,$1380,$1400,$1480	; 78
...
.done:
	...
	movea.l	(sp)+,a2
	addq.w	#2,a3
	bra.s	Dynamic_Normal.customCounters
; ===========================================================================
...
; loc_40330:
LoadLevelBlocks:
	move.l	(a0)+,(a1)+	; copy blocks to RAM
...
__LABEL___Len := __LABEL___End - __LABEL___Blocks
	...
	dc.w bytesToLcnt(__LABEL___Len)
__LABEL___Blocks:
    endm
