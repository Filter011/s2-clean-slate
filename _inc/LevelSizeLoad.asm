...
LevelSizeLoad:
	...
	move.w	d0,(Scroll_flags_copy).w
	move.w	d0,(Scroll_flags_BG_copy).w
	move.w	d0,(Scroll_flags_BG2_copy).w
	move.w	d0,(Scroll_flags_BG3_copy).w
	move.b	d0,(Deform_lock).w
	move.b	d0,(Screen_Shaking_Flag_HTZ).w
