...
ObjPtr_SonicSS:		dc.l ObjNull	; Sonic in Special Stage
...
ObjPtr_TailsSS:		dc.l ObjNull	; Tails in Special Stage
...
ObjPtr_SSEmerald:	dc.l ObjNull	; Emerald from Special Stage
ObjPtr_SSMessage:	dc.l ObjNull	; Messages/checkpoint from Special Stage
ObjPtr_SSRingSpill:	dc.l ObjNull	; Ring spray/spill in Special Stage
ObjPtr_Masher:		dc.l Obj5C	; Masher (jumping piranha fish badnik) from EHZ
ObjPtr_CPZBoss:		dc.l Obj5D	; CPZ boss
ObjPtr_SSHUD:		dc.l ObjNull	; HUD from Special Stage
ObjPtr_StartBanner:
ObjPtr_EndingController:dc.l ObjNull	; Start banner/"Ending controller" from Special Stage
ObjPtr_SSRing:		dc.l ObjNull	; Rings from Special Stage
ObjPtr_SSBomb:		dc.l ObjNull	; Bombs from Special Stage
			dc.l ObjNull	; Obj62
ObjPtr_SSShadow:	dc.l ObjNull	; Character shadow from Special Stage
...
ObjPtr_SSResults:	dc.l ObjNull	; End of special stage results screen
...
ObjPtr_SSNumberOfRings:	dc.l ObjNull	; Number of rings in Special Stage
ObjPtr_SSTailsTails:	dc.l ObjNull	; Tails' tails in Special Stage
...
ObjPtr_CutScene:	dc.l ObjNull	; Cut scene at end of game
ObjPtr_EndingSeqClouds:	dc.l ObjNull	; Background clouds from ending sequence
ObjPtr_EndingSeqTrigger:dc.l ObjNull	; Trigger for rescue plane and birds from ending sequence
ObjPtr_EndingSeqBird:	dc.l ObjNull	; Birds from ending sequence
ObjPtr_EndingSeqSonic:
ObjPtr_EndingSeqTails:	dc.l ObjNull	; Sonic and Tails jumping off the plane from ending sequence
ObjPtr_TornadoHelixes:	dc.l ObjNull	;"Plane's helixes" from ending sequence
			dc.l ObjNull	; ObjD0
			dc.l ObjNull	; ObjD1
...
ObjPtr_ContinueText:
ObjPtr_ContinueIcons:	dc.l ObjNull	; Continue text
ObjPtr_ContinueChars:	dc.l ObjNull	; Sonic lying down or Tails nagging (continue screen)
