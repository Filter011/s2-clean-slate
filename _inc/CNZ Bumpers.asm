...
SpecialCNZBumpers_Init:
	...
	lea	SpecialCNZBumpers_Act1(pc),a1
	tst.b	(Current_Act).w
	beq.s	+
	lea	SpecialCNZBumpers_Act2(pc),a1
+
...
CNZ_Bumper_loop:
	...
	add.w	d1,d0
	bcs.s	loc_17536
	bra.s	CNZ_Bumper_next
; ===========================================================================

loc_17530:
	cmp.w	d4,d0
	bhi.s	CNZ_Bumper_next
