...
PlrList_Std1: plrlistheader
	...
	plreq ArtTile_ArtNem_Ring_sparkles, ArtNem_Ring_sparkles
...
PlrList_Hpz1: plrlistheader
	plreq ArtTile_ArtNem_HPZ_Bridge, Nem_HPZ_Bridge
	plreq ArtTile_ArtNem_HPZ_Waterfall, Nem_HPZ_Waterfall
	plreq ArtTile_ArtNem_HPZPlatform, Nem_HPZ_Platform
	plreq ArtTile_ArtNem_HPZOrb, Nem_HPZ_PulsingBall
	plreq ArtTile_ArtNem_HPZ_Various, Nem_HPZ_Various
	plreq ArtTile_ArtNem_HPZ_Emerald, Nem_HPZ_Emerald
