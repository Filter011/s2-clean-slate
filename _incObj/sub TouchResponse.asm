...
loc_3F81C:
	movea.w	a0,a3
	bsr.w	AddPoints
	move.b	#ObjID_Explosion,id(a1) ; load obj
	move.b	#0,routine(a1)
...
HurtCharacter:
	...
	bne.s	Hurt_Shield
	move.b	#ObjID_LostRings,id(a1) ; load obj
...
Hurt_ChkSpikes:
	...
	moveq	#SndID_HurtBySpikes,d0	; load spikes damage sound
...
loc_3FA00:
	...
	beq.s	loc_3FA12
	addq.b	#2,collision_property(a1)
	rts
; ===========================================================================
