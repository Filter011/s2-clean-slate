...
Obj3C_Init:
	...
	move.w	#ArtTile_ArtNem_BreakWall|palette_line_2,art_tile(a0)
...
+
	...
	addq.w	#4,x_pos(a1)
	lea	Obj3C_FragmentSpeeds_LeftToRight(pc),a4
	move.w	x_pos(a0),d0
	cmp.w	x_pos(a1),d0
	blo.s	+
	subq.w	#8,x_pos(a1)
	lea	Obj3C_FragmentSpeeds_RightToLeft(pc),a4
+
...
BreakObjectToPieces_InitObject:
	move.b	#4,routine(a1)
	move.b	d4,id(a1) ; load object with ID of parent object and routine 4
	...
	move.l	(a4)+,x_vel(a1)	; and y_vel
	dbf	d1,BreakObjectToPieces_Loop

loc_15E82:
	moveq	#SndID_SlowSmash,d0
	jmp	(PlaySound).w
