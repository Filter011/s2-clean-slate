...
Obj50_Init:
	...
	move.b	#ObjID_Aquis,id(a1) ; load obj50
...
Obj50_Wing:
	...
	bne.s	JmpTo48_DeleteObject		; if not, branch
	btst	#status.npc.no_balancing,status(a1)	; is parent object marked as destroyed?
	bne.s	JmpTo48_DeleteObject		; if yes, branch
	lea	Ani_obj50(pc),a1
	jsr	(AnimateSprite).l
	jmp	(DisplaySprite).l
...
; loc_2CE14:
Obj50_Chase:
	bra.w	Obj50_FollowPlayer
; ===========================================================================
; loc_2CE1A:
Obj50_Shooting:
	bsr.w	Obj50_WaitForNextShot
	; fall into Obj50_ChkIfShoot
; ===========================================================================
; loc_2CE24:
Obj50_ChkIfShoot:
	...
	jsr	(Obj_GetOrientationToPlayer).l
	...
	move.b	#2,anim(a1)
	moveq	#$A,d0		; set y offset
	moveq	#$10,d1		; set x offset
