...
Obj14_Init:
	...
	bne.s	loc_219A4
	move.b	#ObjID_Seesaw,id(a1) ; load obj14
	addq.b	#6,routine(a1)
...
Obj14_UpdateMappingAndCollision:
	bsr.s	Obj14_SetMapping
	lea	byte_21C8E(pc),a2
	btst	#0,mapping_frame(a0)
	beq.s	+
	lea	byte_21CBF(pc),a2
+
	move.w	x_pos(a0),-(sp)
	moveq	#0,d1
...
Obj14_LaunchCharacter:
	...
	moveq	#SndID_Spring,d0    ; play spring sound
	jmp	(PlaySound).w
; ===========================================================================
