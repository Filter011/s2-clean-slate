...
Obj5D_Main:
	...
	lea	Ani_obj5D_b(pc),a1
	jsr	(AnimateSprite).l
	moveq	#1<<status.npc.x_flip|1<<status.npc.y_flip,d0
	and.b	status(a0),d0
...
Obj5D_Main_CreateExplosion:
	...
	bne.s	+	; rts
	move.b	#ObjID_BossExplosion,id(a1) ; load obj58
...
Obj5D_Pipe_Pump_2:
	...
	subq.b	#1,Obj5D_timer(a0)	; animation timer
	bne.s	Obj5D_Pipe_Pump_2_End
	; when timer reaches zero
	move.b	#$12,Obj5D_timer(a0)	; reset animation timer
	subq.b	#8,Obj5D_y_offset(a0)	; move one segment up
...
Obj5D_Pipe_Pump_2_End:
	...
	add.w	d0,y_pos(a0)
	lea	Ani_Obj5D_Dripper(pc),a1
	jsr	(AnimateSprite).l
	jmp	(DisplaySprite).l
; ===========================================================================

Obj5D_Pipe_Pump_4:
	subq.b	#1,Obj5D_timer(a0)	; wait a few frames
	beq.s	+
	rts
; ---------------------------------------------------------------------------
+
...
loc_2DFF0:
	...
	subq.b	#8,Obj5D_y_offset(a0)	; position of next segment up
	beq.s	loc_2DFD8
