...
+
	...
	move.w	#ArtTile_ArtNem_BallThing|palette_line_3,art_tile(a0)
...
; Obj46_InitPressureSpring:	; loads the spring under the ball
	...
	bne.s	+
	move.b	#ObjID_OOZBall,id(a1) ; load obj46
	addq.b	#6,routine(a1)
	move.w	x_pos(a0),x_pos(a1)
	move.w	y_pos(a0),y_pos(a1)
	addi.w	#$12,y_pos(a1)
	move.l	#Obj45_MapUnc_2451A,mappings(a1)
	move.w	#ArtTile_ArtNem_PushSpring|palette_line_2,art_tile(a1)
