...
loc_1921E:
	...
	move.w	#ArtTile_ArtNem_Signpost,art_tile(a0)
...
Obj0D_Main:
	...
	cmpi.w	#$20,d0
	bhs.s	loc_19350
	moveq	#SndID_Signpost,d0
	jsr	(PlaySound).w	; play spinning sound
...
loc_19398:
	...
	bne.s	return_19406
	move.b	#ObjID_Ring,id(a1) ; load obj25 (a ring) for the sparkly effects over the signpost
	...
	move.w	#ArtTile_ArtNem_Ring_sparkles|palette_line_1,art_tile(a1)
