...
Obj55_Main_Wait:
	btst	#7,Obj55_status(a0)	; was boss hit?
	bne.s	+			; if yes, branch
	bsr.s	Obj55_HoverPos
	subq.w	#1,(Boss_Countdown).w	; hover in place for a while
...
Obj55_LaserShooter_Rise:
	...
	addq.b	#2,boss_routine(a0)	; => Obj55_LaserShooter_ChooseTarget
...
+
	...
	subq.b	#1,Obj55_shot_count(a0)		; decrement number of shots left
...
Obj55_LaserShooter_End:
	bsr.s	Obj55_LaserShooter_FacePlayer
...
Obj55_LaserShooter_FacePlayer:
	...
	subq.w	#8,d0		; allow an 8 pixel margin
	blt.s	return_333F6
...
Obj55_LaserShooter_FaceLeft:
	addq.w	#8,d0		; allow an 8 pixel margin
	bgt.s	return_333F6
	bclr	#render_flags.x_flip,render_flags(a0)
	rts
; ===========================================================================
...
Obj55_LaserShooter_Wind:
	...
	move.b	d3,d0
	bsr.s	Obj55_LaserShooter_CalcSineRelative
	move.w	d1,x_pos(a0)
	move.w	d0,y_pos(a0)
...
Obj55_SpikeChain_Move:
	...
	addi.b	#$40,d0
	move.b	d0,d3
	bsr.s	Obj55_SpikeChain_Rotate
	move.w	d1,x_pos(a0)
	move.w	d0,y_pos(a0)
	addq.b	#1,boss_sine_count(a0)
	moveq	#7,d2
	moveq	#0,d4
...
Obj55_Laser_ChkGround:
	...
	bmi.s	Obj55_Laser_ChkGroundLeft	; if yes, branch
	move.w	x_pos(a0),d0
	cmpi.w	#$2980,d0
	bhs.s	return_33626
	cmpi.w	#$297C,d0
...
-	move.l	(a0,d0.w),(a1,d0.w)	; make new object a copy of this one
	...
	moveq	#$10,d0		; place new wave object 16 pixels next to current one
