...
+
	moveq	#tiles_to_words(6),d3	; DMA transfer length (in words)
...
Obj0A_WarnSound:
	...
	moveq	#SndID_WaterWarning,d0
	jsr	(PlaySound).w

; loc_1D69C:
Obj0A_ReduceAir:
	subq.b	#1,air_left(a2)		; subtract 1 from air remaining
	bcc.w	Obj0A_MakeBubbleNow	; if air is above 0, branch
	; Drown the player.
	move.b	#$81,obj_control(a2)	; lock controls
	moveq	#SndID_Drown,d0
...
+
	...
	tst.w	obj0a_time_until_freeze(a0)
	beq.s	Obj0A_MakeNumberBubbleMaybe
