...
Obj17_Init:
	...
	move.w	#ArtTile_ArtNem_GHZ_Spiked_Log|palette_line_2,art_tile(a0)
...
Obj17_MakeHelix:
	...
	move.b	d5,(a2)+
	move.b	#4,routine(a1)
	move.b	d4,id(a1) ; load obj17
	move.w	d2,y_pos(a1)
	move.w	d3,x_pos(a1)
	move.l	mappings(a0),mappings(a1)
	move.w	#ArtTile_ArtNem_GHZ_Spiked_Log|palette_line_2,art_tile(a1)
