...
; note: $1F is unused and available (however, $1F is cleared by loc_A53A and ObjB2_Landed_on_plane)
...
GameModeID_OptionsMenu =	id(GameMode_OptionsMenu) ; 10
GameModeID_LevelSelect =	id(GameMode_LevelSelect) ; 14
...
AniIDSonAni_Push		= id(SonAni_Push_ptr)		;  3 ;   3
AniIDSonAni_Wait		= id(SonAni_Wait_ptr)		;  4 ;   4
AniIDSonAni_Balance		= id(SonAni_Balance_ptr)	;  5 ;   5
AniIDSonAni_LookUp		= id(SonAni_LookUp_ptr)		;  6 ;   6
AniIDSonAni_Duck		= id(SonAni_Duck_ptr)		;  7 ;   7
AniIDSonAni_Spindash		= id(SonAni_Spindash_ptr)	;  8 ;   8
AniIDSonAni_Blink		= id(SonAni_Blink_ptr)		;  9 ;   9 ; Exclusive to Sonic
AniIDSonAni_GetUp		= id(SonAni_GetUp_ptr)		; 10 ;  $A ; Exclusive to Sonic
AniIDSonAni_Balance2		= id(SonAni_Balance2_ptr)	; 11 ;  $B ; Exclusive to Sonic
AniIDSonAni_Stop		= id(SonAni_Stop_ptr)		; 12 ;  $C
AniIDSonAni_Float		= id(SonAni_Float_ptr)		; 13 ;  $D
AniIDSonAni_Float2		= id(SonAni_Float2_ptr)		; 14 ;  $E
AniIDSonAni_Spring		= id(SonAni_Spring_ptr)		; 15 ;  $F
AniIDSonAni_Hang		= id(SonAni_Hang_ptr)		; 16 ; $10
AniIDSonAni_Dash2		= id(SonAni_Dash2_ptr)		; 17 ; $11 ; Unused.
AniIDSonAni_Dash3		= id(SonAni_Dash3_ptr)		; 18 ; $12 ; Unused.
AniIDSonAni_Hang2		= id(SonAni_Hang2_ptr)		; 19 ; $13
AniIDSonAni_Bubble		= id(SonAni_Bubble_ptr)		; 20 ; $14
AniIDSonAni_DeathBW		= id(SonAni_DeathBW_ptr)	; 21 ; $15
AniIDSonAni_Drown		= id(SonAni_Drown_ptr)		; 22 ; $16
AniIDSonAni_Death		= id(SonAni_Death_ptr)		; 23 ; $17
AniIDSonAni_Hurt		= id(SonAni_Hurt_ptr)		; 24 ; $18
AniIDSonAni_Hurt2		= id(SonAni_Hurt2_ptr)		; 25 ; $19
AniIDSonAni_Slide		= id(SonAni_Slide_ptr)		; 26 ; $1A
AniIDSonAni_Blank		= id(SonAni_Blank_ptr)		; 27 ; $1B
AniIDSonAni_Balance3		= id(SonAni_Balance3_ptr)	; 28 ; $1C ; Exclusive to Sonic
AniIDSonAni_Balance4		= id(SonAni_Balance4_ptr)	; 29 ; $1D ; Exclusive to Sonic
AniIDSupSonAni_Transform	= id(SupSonAni_Transform_ptr)	; 30 ; $1E ; Exclusive to Sonic
AniIDSonAni_Lying		= id(SonAni_Lying_ptr)		; 31 ; $1F ; Exclusive to Sonic
AniIDSonAni_LieDown		= id(SonAni_LieDown_ptr)	; 32 ; $20 ; Exclusive to Sonic
...
Block_Table:			ds.w	$C00	; maximum size of $1800
Block_Table_End:
...
Ring_Manager_RAM_Addresses:
Ring_start_addr_RAM:		ds.w	1
Ring_Manager_RAM_Addresses_End:
...
ArtTile_ArtNem_Ring_loss              = ArtTile_ArtNem_Ring + 4
ArtTile_ArtNem_Ring_sparkles          = ArtTile_ArtNem_Ring + 8
...
ArtTile_ArtNem_HPZ_Various            = $037C
